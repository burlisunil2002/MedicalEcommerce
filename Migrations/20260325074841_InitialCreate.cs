        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentScreenshot = table.Column<string>(type: "text", nullable: true),
                    UTRNumber = table.Column<string>(type: "text", nullable: true),
                    PaymentStatus = table.Column<string>(type: "text", nullable: true),
                    PaymentVerifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ItemStatus = table.Column<string>(type: "text", nullable: true),
                    ItemOrderModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdminOrderId = table.Column<int>(type: "integer", nullable: false),
                    OrderId = table.Column<int>(type: "integer", nullable: false),
                    AdminName = table.Column<string>(type: "text", nullable: false),
                    AdminModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondaryMobile = table.Column<string>(type: "text", nullable: true),
                    ...
                    GSTBusinessName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lgnm = table.Column<string>(type: "text", nullable: false),
                    tradeNam = table.Column<string>(type: "text", nullable: false),
                    sts = table.Column<string>(type: "text", nullable: false),
                    rgdt = table.Column<string>(type: "text", nullable: false),
                    ctb = table.Column<string>(type: "text", nullable: false),
                    stj = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GstVerification", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPaymentVerified = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GSTPercentage = table.Column<int>(type: "integer", nullable: false),
                    PriceType = table.Column<string>(type: "text", nullable: false),
                    ImagePath = table.Column<string>(type: "text", nullable: false),
                    QuotationPath = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    UTRNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PaymentScreenshot = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
